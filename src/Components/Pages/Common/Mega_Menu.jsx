      ...
      html: (
        <div className="contactLists">
          ...
          <h5 className="popupMedias">
            <ul>
              <li>
                <a href="https://www.facebook.com/bankwegagen">
                  <BsFacebook />
                </a>
              </li>
              <li>
                <a href="https://t.me/WegagenBanksc">
                  <BsTelegram />
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/company/66893778/admin/">
                  <BsLinkedin />
                </a>
              </li>
              <li>
                <a href="https://twitter.com/WegagenBanksc">
                  <BsTwitter />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/wegagenbankofficial/">
                  <BsInstagram />
                </a>
              </li>
              <li>
                <a href="https://https://youtube.com/channel/UCksW-3Q5a3TKos-jTQp-LCA?view_as=subscriber">
                  <BsYoutube />
                </a>
              </li>
            </ul>
    ...
    <>
      {isOpen && (
        <div className="sidebar-overlay" onClick={toggleSidebar}>
          <div
            className={`custom-sidebar animate__animated ${animation}`}
          ...
          >
            ...
            <div className="sidebar-item">
              ...
              >
                <span className="link-icon">
                  <FaInfoCircle className="react-icon" />
                  <p>About Us</p>
                </span>
              ...
              >
                ...
                <a onClick={handleClick} style={{ color: "#004360" }}>
                  Timeline
                </a>
            ...
            <div className="sidebar-item">
              <div
                className="sidebar-link2"
                onClick={() => toggleMenu("BankingServices")}
              >
                <span className="link-icon">
                  <GiBanknote className="react-icon" />
              ...
              >
                <div
                  className="sidebar-link2"
                  onClick={() => toggleMenu("PersonalBanking")}
              ...
              >
                <div
                  className="sidebar-link2"
                  onClick={() => toggleMenu("LoanFacilities")}
                  style={{ marginLeft: "10px", fontSize: "15px" }}
                >
                  <span className="link-icon">
                    <p>Loan Facilities</p>
                ...
                >
                  ...
                  <a href="/Letter_of_Bank_Guarantee_Facilities">
                    Letter of Bank Guarantee Facilities
                  </a>
                  <a href="/Rental_Loan">Retail Loans</a>
                  <a href="/Diaspora_Loans">Diaspora Loans</a>
                  <a href="/Personal_Loans_for_Salaried_Persons">
              ...
              >
                <div
                  className="sidebar-link2"
                  onClick={() => toggleMenu("InternationalBanking")}
                  style={{ marginLeft: "10px", fontSize: "15px" }}
                >
                  <span className="link-icon">
                ...
                >
                  ...
                  <a onClick={international_Banking4}>
            ...
            <div className="sidebar-item">
              <div
                className="sidebar-link2"
                onClick={() => toggleMenu("DigitalBanking")}
              >
                <span className="link-icon">
                  <IoPhonePortrait className="react-icon" />
                  <p>Digital Banking</p>
                </span>
                <span
                  className={`dropdown-icon ${
            ...
            <div className="sidebar-item">
              <div
                className="sidebar-link2"
                onClick={() => toggleMenu("InterestFree")}
              >
                <span className="link-icon">
                  <BsMoonStarsFill className="react-icon" />
                  <p>Interest Free</p>
                </span>
                <span
                  className={`dropdown-icon ${
              ...
              >
                <div
                  className="sidebar-link2"
                  onClick={() => toggleMenu("SavingAccount")}
                  style={{ marginLeft: "10px", fontSize: "15px" }}
                >
                  <span className="link-icon">
                    <p>Saving Account</p>
            ...
            <div className="sidebar-item">
              <div
                className="sidebar-link2"
                onClick={() => toggleMenu("Medias")}
              >
                <span className="link-icon">
                  <MdPermMedia className="react-icon" />
                  <p>Medias</p>
                </span>
            ...
            <div className="sidebar-item">
              <div
                className="sidebar-link2"
                onClick={() => toggleMenu("Tarrifs")}
              >
                <span className="link-icon">
                  <BsFileEarmarkFontFill className="react-icon" />
                  <p>Tarrifs</p>
                </span>
              ...
              >
                ...
                <a href="/Digital_Terms_And_Tariffs">
                  Digital Banking Terms and Tarrifs
                </a>
                <a href="/Credit_Terms_And_Tariffs">Credit Terms and Tarrifs</a>
                <a href="/International_Terms_And_Tariffs">
                  IBD Terms and Tarrifs
                </a>
            ...
            <div className="sidebar-item">
              <div className="sidebar-link" onClick={handleClick7}>
                <span className="link-icon">
                  <FaHandshakeAngle />
                </span>
                CSR
      ...
      <div
        className={
          headerSelect === "interestFree"
            ? `navigation2 ${scrolled ? "scrolled" : ""}`
            : `navigation1 ${scrolled ? "scrolled" : ""}`
        }
        ref={refOne}
      >
        <div className="headerContent">
          ...
          >
            ...
            >
              <h6>
                <Link
                  ...
                  style={
                    path === "home"
                      ? { color: getColor(), textDecoration: "none" }
                      : { textDecoration: "none" }
                  }
                >
                  Home
            ...
            >
              ...
              <p style={{ display: "flex", alignItems: "center" }}>
                <MdKeyboardArrowDown size="17px"></MdKeyboardArrowDown>
              </p>
            </div>
          ...
          {headerSelect == "interestFree" ? (
            <div
              className="WegegenLogo"
              onMouseOver={() => {
                setPop(false), setShow("Home1");
              }}
            >
              <img src={wadya}></img>
              <p>
        ...
        <div>
          {popup === true ? (
            <>
              <div className="popup">
                <div
                  className="popupInner animate__animated animate__fadeInUp custom-animation-duration"
                  ref={refOne}
                >
                  {show === "Home" ? (
                    <>
                      ...
                      <div className="aboutusNav animate__animated animate__fadeInUp custom-animation-duration">
                        ...
                        <div>
                          {showContent === 1 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                Established on November, 1996, Wegagen Bank S.C.
                                emerged from the visionary mindset of sixteen
                                founding members who recognized the pivotal role
                                financial institutions would play in fostering
                        ...
                        {showContent === 1 ? (
                          <div
                            style={{ paddingLeft: "15px", transition: ".7s" }}
                          >
                            <p>
                              <img
                              ...
                              <div className="aboutusNavItems">
                                ...
                                >
                                  <Link
                                    ...
                                    to="/Personal_Banking"
                                  >
                                    <p> Local currency saving accounts </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                                ...
                                >
                                  <Link
                                    ...
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p> Nigat (Women) Saving Account </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                                ...
                                >
                                  <Link
                                    ...
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p> Elders/Warka Saving Account </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                          ...
                          {showContent === 2 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              <div className="aboutusNavItems">
                                ...
                                >
                                  <Link
                                    to="/Letter_of_Bank_Guarantee_Facilities"
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p style={{ fontSize: "15px" }}>
                                      Letter of Bank Guarantee Facilities{" "}
                                ...
                                >
                                  <Link
                                    to="/Personal_Loans_for_Salaried_Persons"
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p style={{ fontSize: "15px" }}>
                                      Personal Loans for Salaried Persons{" "}
                            ...
                            <div className="popupContent animate__animated animate__zoomIn">
                              <div className="aboutusNavItems">
                                <div
                                  ...
                                  onClick={international_Banking}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                                  >
                                ...
                                <div
                                  ...
                                  onClick={international_Banking2}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p> Cash Against Documents </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                                ...
                                <div
                                  ...
                                  onClick={international_Banking3}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                                ...
                                <div
                                  ...
                                  onClick={international_Banking4}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p> Consignment Basis Payment </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                                ...
                                <div
                                  ...
                                  onClick={international_Banking5}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                                  >
                                    <p> Small Export Items </p>
                                  </Link>
                                  <h6
                                    style={{
                                      display: "flex",
                                ...
                                <div
                                  ...
                                  onClick={international_Banking6}
                                >
                                  <Link
                                    to="/International_Banking"
                                    style={{ textDecoration: "none" }}
                        ...
                        <div>
                          {showContent === 1 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                Offers easy and convenient access to make
                                withdrawals and payment through our ATM and POS
                                network
                              </p>
                            </div>
                          ) : (
                          ...
                          {showContent === 2 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                Enables schools and learning institutions to
                                collect fees and offers a comprehensive school
                                management system
                              </p>
                            </div>
                          ) : (
                          ...
                          {showContent === 3 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                This is a mobile banking service which provides
                                convenient and secure means of making payments
                          ...
                          {showContent === 4 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                This digital channel provides browser-based
                                access to customers to review transactions and
                                make payments.
                              </p>
                            </div>
                          ) : (
                          ...
                          {showContent === 5 ? (
                            <div className="popupContent animate__animated animate__zoomIn">
                              ...
                              >
                                Aiming to expand reach and pursue financial
                                inclusion, offers network of capable agents to
                                provide banking service on behalf of Wegagen
                                Bank
                              </p>
                            </div>
                          ) : (
                          ...
                          {showContent === 1 ? (
                            ...
                            <div className="aboutusNavItems animate__animated animate__zoomIn">
                              <div
                                ...
                                onClick={interest_free}
                              >
                                <Link
                                  to="/Wadya_Aman_Saving"
                                  style={{ textDecoration: "none" }}
                                >
                                  <p> Wadia Amana Account </p>
                                </Link>
                                <h6
                                  style={{
                                    display: "flex",
                              ...
                              <div
                                ...
                                onClick={interest_free2}
                              >
                                <Link
                                  to="/Wadya_Aman_Saving"
                                  style={{ textDecoration: "none" }}
                                >
                                  <p> Muday wadia amana </p>
                                </Link>
                                <h6
                                  style={{
                                    display: "flex",
                              ...
                              <div
                                ...
                                onClick={interest_free3}
                              >
                                <Link
                                  to="/Wadya_Aman_Saving"
                                  style={{ textDecoration: "none" }}
                                >
                                  <p> Equb wadia amana </p>
                                </Link>
                                <h6
                                  style={{
                                    display: "flex",
                              ...
                              <div
                                ...
                                onClick={interest_free4}
                              >
                                <Link
                                  to="/Wadya_Aman_Saving"
                                  style={{ textDecoration: "none" }}
                                >
                                  <p> Zakat wadia amana </p>
                                </Link>
                                <h6
                                  style={{
                                    display: "flex",
                              ...
                              <div
                                ...
                                onClick={interest_free5}
                              >
                                <Link
                                  to="/Wadya_Aman_Saving"
                                  style={{ textDecoration: "none" }}
                                >
                                  <p> School wadia amana </p>
                                </Link>
                                <h6
                                  style={{
                                    display: "flex",
