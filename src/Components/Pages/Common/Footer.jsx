...
export default function Footer({ footerColor }) {
        ...
        <div className="termsAndTarrifs">
          ...
          <>
            <p
              ...
              onClick={Branch_Terms_And_Tariffs}
            >
              Branch Banking Terms and Tariffs
            </p>
            <p
              style={{ textAlign: "center", cursor: "pointer" }}
              onClick={Digital_Terms_And_Tariffs}
            >
              {" "}
            ...
            <p
              style={{ textAlign: "center", cursor: "pointer" }}
              onClick={Credit_Terms_And_Tariffs}
            >
              {" "}
              Credit Terms and Tariffs{" "}
            </p>
            <p
              style={{ textAlign: "center", cursor: "pointer" }}
              onClick={International_Terms_And_Tariffs}
            >
              {" "}
            ...
            <p
              style={{ textAlign: "center", cursor: "pointer" }}
              onClick={Efoyta_Terms_And_Tariffs}
            >
              {" "}
              Efoyta Terms And Tariffs{" "}
            </p>
            <p
              style={{ textAlign: "center", cursor: "pointer" }}
              onClick={Share_Terms_and_Tariffs}
            >
              {" "}
              Share Administration Terms and Tariffs{" "}
            </p>
          </>
        </div>
      ),
          ...
          <div className={styles.popexchange} style={{ marginBottom: "10px" }}>
            ...
            <table>
              <thead>
                ...
                <th></th>
                <th></th>
                <th colSpan={2} style={{ paddingLeft: "6%" }}>
                  Cash & Remittance
                </th>
                <th colSpan={2} style={{ paddingLeft: "6%" }}>
                  Transactions
  ...
  useEffect(() => {
    ...
    fetch("https://weg.back.strapi.wegagen.com/api/adeles?populate=*")
      ...
      .then((data) => {
        const pdfFile =
          data.data[0]?.attributes?.file?.data[0]?.attributes?.url;
        if (pdfFile) {
  ...
  return (
    <div
      ...
      style={
        footerColor == "wadya"
          ? { backgroundColor: getColor(), textDecoration: "none" }
          : { textDecoration: "none" }
      }
    >
      <div className="footerContents">
        ...
        <div className="usefulLinkd">
          ...
          <Link to="/ATM_Location" style={{ textDecoration: "none" }}>
            <p>ATM Locator</p>
          </Link>
          <Link to="/Branch_Location" style={{ textDecoration: "none" }}>
            <p>Branches</p>
          </Link>
          ...
          <Link to="/wegagen-privacy-policy" style={{ textDecoration: "none" }}>
            <p>Wegagen Bank's polices</p>{" "}
          </Link>
        </div>
        ...
        <div className="customerSupport2">
          <p
            style={{
              fontSize: "20px",
              "@media (max-width: 768px)": {
                // Change 768px to whatever breakpoint you prefer
                fontSize: "15px",
              },
            }}
          >
          ...
          <Link to="/annualReport" style={{ textDecoration: "none" }}>
            <p>Annual Reports</p>
          </Link>
          <Link to="/BankFormat" style={{ textDecoration: "none" }}>
            <p>Bank Format</p>
          </Link>
      ...
      <div className="footerSocialMedias">
        ...
        <ul>
          ...
          <a
            href="https://x.com/WegagenBanksc"
            target="_blank"
            rel="noopener noreferrer"
          >
            <li>
          ...
          <a
            href="https://www.linkedin.com/company/66893778/admin/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <li>
          ...
          <a
            href="https://www.youtube.com/channel/UCksW-3Q5a3TKos-jTQp-LCA?view_as=subscriber"
            target="_blank"
            rel="noopener noreferrer"
          >
            <li>
