                ...
                <div className='contactLists'>
                    ...
                    <h5 className='popupMedias'>
                        <ul>
                            ...
                            <li><a href='https://twitter.com/WegagenBanksc'><FaXTwitter /></a></li>
    ...
    return (
        <>
            <div className='headers'>
                <div className='vacancy2 animate__animated animate__fadeInRight'>
                ...
                <div className='socialMediasLinks animate__animated animate__fadeInRight'>
                    <label><a href='https://www.facebook.com/bankwegagen'><FaFacebookF /></a></label>
                    <label><a href='https://twitter.com/WegagenBanksc'><FaXTwitter /></a></label>
                    <label><a href='https://t.me/WegagenBanksc'><FaTelegramPlane /></a></label>
                    <label><a href='https://linkedin.com/company/66893778/admin/'><FaLinkedinIn /></a></label>
                    <label><a href='https://youtube.com/channel/UCksW-3Q5a3TKos-jTQp-LCA?view_as=subscriber'><BsYoutube /></a></label>
                    <label><a href='https://www.instagram.com/wegagenbankofficial/'><BsInstagram /></a></label>
                </div>
