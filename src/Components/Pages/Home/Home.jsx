...
export default function Home() {
    ...
    MySwal.fire({
      html: (
        <div className={styles.popOuter}>
          ...
          <p>
            Our Agar Card enables customers to access their money at any time,
            24/7, without being restricted by bank operating hours, make
            withdrawals up to Birr 10,000, make payments and check account
            balance.
          </p>
        </div>
      ),
    ...
    MySwal.fire({
      html: (
        <div className={styles.popOuter}>
          ...
          <p>
            Nigat Card enables our women customer with Nigat Saving Account to
            access their money at any time, 24/7, without being restricted by
            bank operating hours, make withdrawals up to Birr 10,000, make
    ...
    MySwal.fire({
      html: (
        <div className={styles.popOuter}>
          ...
          <p>
            Amana Card enables our Interest Free Banking (IFB) customers to
      ...
      MySwal.fire({
        html: (
          <div className={styles.popOuter} style={{ minHeight: "500px" }}>
            <label className={styles.popTitle}>
              {newsData.data.attributes.title}
            </label>
            ...
            {newsData.data.attributes.news_related_images?.data?.length > 0 ? (
              ...
              >
                {newsData.data.attributes.news_related_images.data.map(
                  (image, index) => (
                    <img
                      key={index}
                      src={`https://weg.back.strapi.wegagen.com${image.attributes.url}`}
                      alt=""
              ...
              >
                Wegagen Bank SC.
              </p> // Or render a default image or simply hide this section
            )}
          </div>
        ),
        showConfirmButton: false,
  ...
  return (
    <div>
      ...
      <div className={styles.stayConnected}>
        ...
        >
          ...
          <p className={styles.paragraph}>
            Elevate your banking experience with our radical mobile banking app
            and innovative digital platform “Wegagen Mobile”. Our bank is
            dedicated to providing unparalleled, convenient and secured mobile
            banking service which ensures seamless access to your accounts and
            transactions anytime, anywhere. You can download our Wegagen Mobile
            app on Google Play Store or Apple Store.
          </p>
      ...
      <div>
        <p className={styles.correspondentBanks}>
          Money Transfer <span>Agents</span>
        </p>
        <hr className="hr" />
      ...
      <div className={styles.Ebanking}>
        <ul>
          <li
            className={dispaly === 1 ? styles.active : styles.notActive}
            onMouseOver={() => setDisplay(1)}
          >
            <span>Efoyta</span> Digital Lending
          </li>
          <li
            className={dispaly === 2 ? styles.active : styles.notActive}
            onMouseOver={() => setDisplay(2)}
          >
            <span>Mobile</span> Banking
          </li>
          <li
            className={dispaly === 3 ? styles.active : styles.notActive}
            onMouseOver={() => setDisplay(3)}
          >
            <span>Internet</span> Banking
          </li>
          <li
            className={dispaly === 4 ? styles.active : styles.notActive}
          ...
          <div className="animate__animated animate__bounceInUp customAnimationDuration">
            <div className={styles.business}>
              <div className={styles.rightSide}>
                ...
                <p className={styles.paragraph}>
                  We understand the unique financing needs of SMEs and MSMEs.
                  That's why we offer competitive interest rates to timely meet
                  your financing needs. Our intuitive Efoyta application makes
                  it easy to apply for a business loan in just a few minutes.
                  Simply provide some basic information about your business, and
                  our advanced algorithms will assess your eligibility and
                  provide a decision quickly. Our team of experienced lending
                  specialists is here to guide you through the process every
                  step of the way.
                </p>
              </div>
          ...
          <div className="animate__animated animate__bounceInUp customAnimationDuration">
            <div className={styles.business}>
              <div className={styles.rightSide}>
                ...
                <p className={styles.headerTitle2}>Your Phone Your Bank</p>
                <p className={styles.paragraph}>
                  With our highly convenient Wegagen Mobile app, you can embark
                  on a seamless and digital mobile banking experience like never
                  before. Wegagen Mobile app supports five languages - Amharic,
                  English, Afaan Oromo, Tigrigna, and Somali, ensuring
                  accessibility for all. Additionally, customers can dial *866#
                  to get mobile banking services without the need for a smart
                  phone or access to the internet.
                </p>
              </div>
              <div className={styles.rightImg}>
                <img src={mobileBanking}></img>
          ...
          <div className="animate__animated animate__bounceInUp">
            <div className={styles.business}>
              <div className={styles.rightSide}>
                ...
                >
                  With our efficient and dependable "CLICK WEGAGEN" Internet
                  Banking solution, customers can access and manage their
                  accounts anytime, anywhere through an Internet connection
                  using the Bank’s own website. <br />
                </p>
                <p>
                  <a
                    href="https://www.wegagenbanksc.com.et:4443/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    https://www.wegagenbanksc.com.et:4443/
                  </a>
                </p>
              </div>
              <div className={styles.rightImg}>
          ...
          <div className="animate__animated animate__bounceInUp">
            <div className={styles.business}>
              <div className={styles.rightSide}>
                ...
                <p className={styles.paragraph}>
                  With Wegagen Bank's Agar, Nigat, and Amana cards; you can
                  access a wide range of financial services anytime, anywhere.
                  Whether you need to make payments, transfer funds, or manage
                  your accounts, our cards offer flexibility and assurance.
                  Embrace the simplicity of banking with Wegagen Bank's card
                  offerings today!
                </p>
              </div>
              <div className={styles.rightImg}>
      ...
      <div className={styles.newsAndExchange}>
        <div className={styles.news1}>
              ...
              {newsData.map((newsItem) => {
                const firstParagraphText =
                  newsItem.attributes.description[0]?.children
                    ...
                    .join(" ") || "";
                const displayedText =
                  firstParagraphText.slice(0, 140) +
                  (firstParagraphText.length > 140 ? "..." : "");
                ...
                return (
                  ...
                  >
                    <img
                      src={
                        newsItem.attributes.featured_image?.data
                          ? `https://weg.back.strapi.wegagen.com${newsItem.attributes.featured_image.data.attributes.url}`
                          : news
                      }
                      alt="Featured"
                    ...
                    <div className={styles.moreNews}>
                      <p onClick={() => newsDetail(newsItem.id)}>
                        Read More{" "}
                        <FaArrowRight
          ...
          <Link to="/News">
            <button className={styles.seeAllNews}>Read More News</button>
          </Link>
        </div>
      </div>
      ...
      <div>
        <div className={styles.productService}>
          <h4 className={styles.productServicesTitle}>
          ...
          <div className={styles.allServices}>
            ...
            >
              <div>
                <label>
                  Nigat <span>Women Account</span>
                </label>
                <p>
                  Gender-oriented banking solutions which is designed to help
                  women improve their saving habits by offering attractive
                  features for women at all levels of the economic pyramid.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              <div>
                <label>
                  Goh <span>Junior Account</span>
                </label>
                <p>
                  This is a high interest yielding saving account opened by
                  parents/guardians on behalf of their children for their future
                  use when they turn 18 or older
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService2}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              ...
              <div>
                <label>
                  Warka <span>Saving Account</span>
                </label>
                <p>
                  This is a saving account prepared for elders at age of 50 and
                  above yielding a high interest to enhance their saving habits
                  and facilitates hassle free banking experience.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService3}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              ...
              <div>
                <label>
                  Biruh <span>Youth Account</span>
                </label>
                <p>
                  This is a saving account designed for young people in the age
                  range of 18 to 24 years old in which they receive attractive
                  interest based on the amount they deposited.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService4}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              ...
              <div>
                <label>
                  Wegagen Amana <span>IFB</span>
                </label>
                <p>
                  It is a tailored Interest-Free banking service in accordance
                  with Sharia laws, offered through dedicated windows and
                  branches exclusively for our customers.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
            ...
            >
              ...
              <div>
                <label>
                  Foreign Currency<span> Account</span>
                </label>
                <p>
                  A saving account is available for individuals residing in
                  Ethiopia, as well as non-resident Ethiopians and individuals
                  of non-resident Ethiopian origin, in accordance with the
                  issuance of Directive No. FXD/68/2020.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService5}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              <div>
                <label>
                  Edir/Equb <span>Saving Account</span>
                </label>
                <p>
                  A saving account tailored for Equib and Edir unions that offer
                  an interest rate higher than the standard industry market
                  rate.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService6}
                  >
                    Read More
                  </button>
                </div>
            ...
            >
              ...
              <div>
                <label>
                  NOW <span>Account</span>
                </label>
                <p>
                  This is an account offered to institutions and business
                  persons as well as large individual depositors who have less
                  frequent withdrawals.
                </p>
                <div className={styles.readMore2}>
                  <button
                    style={{ display: "flex", justifyContent: "left" }}
                    onClick={bankingService7}
                  >
                    Read More
                  </button>
                </div>
